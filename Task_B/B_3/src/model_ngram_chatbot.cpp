...
// TODO 2 b): Add the notifyUpdate to trigger
// the update function in the View (using the observer mechanism).
// You simply have to add 
//      notifyUpdate(); 
// when the model changes and new text has been generated.
